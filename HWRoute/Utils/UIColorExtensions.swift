...
public extension UIColor {
    ...
    static var appDownViewColor: UIColor {
        return UIColor.init(hex: 0xf1f1f1)
    }
    ...
    static var appSecTintColor: UIColor {
        return UIColor(hex: 0x2c86e0)
    }
    
    static var appConfirmButtonColor: UIColor {
        return UIColor(hex: 0x00bcd4)
    }
    
    static var appTextGray: UIColor {
        return UIColor.init(hex: 0x000000, transparency: 0.54)
    }
    
    static var appTextNormalColor: UIColor {
           return UIColor.init(hex: 0x000000, transparency: 0.87)
    }
    
    static var appTextFieldPlaceholderColor: UIColor {
           return UIColor.init(hex: 0x000000, transparency: 0.38)
    }
    
    static var appTintColor_Normal: UIColor {
        return UIColor(hex: 0xBEBEBE)
    }
    
    static var appSpaceLineColor: UIColor {
    ...
    //tableview灰色底色
    static var appTableViewColor_gray: UIColor {
        return UIColor(hex: 0xf1f1f1)
    }
    //tableview cell颜色
     static var appTableViewCellColor: UIColor {
         return UIColor(hex: 0xffffff)
     }
    //未读通知消息cell颜色
    static var appTableViewUnreandNotificationCellColor: UIColor {
        return UIColor.init(hex: 0x1976d2, transparency: 0.1)
    }
    //导航栏下方分割线的颜色
    static var appNavigationSpaceLineColor: UIColor {
        return UIColor.init(hex: 0xe5e5e5)
    }
    //label textfield的字体颜色
    static var textNormalColor: UIColor {
        return UIColor(hex: 0x191919)
    }
    
    //首页setpassword和backup mnemonics的字体颜色
    static var setPasswordTextColor: UIColor {
        return UIColor(hex: 0xffbb08)
    }
    //确认按钮的背景色
    static var comfirmButtonColor: UIColor {
        return UIColor(hex: 0x00A0FF)
    }
    
    //页面中的分割线颜色
    static var pageContentSpaceLineColor: UIColor {
        return UIColor(hex: 0xc6c6c6)
    }
    
    //创建y钱包tips的字体颜色
   static var createWalletTipsTextColor: UIColor {
       return UIColor(hex: 0xc6c6c6)
   }
    
     //textview背景色是
    static var appTextViewColor: UIColor {
        return UIColor(hex: 0xffffff)
    }
